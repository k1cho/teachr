    ...
    <div class="row medium-padding120">
        <main class="main">
            <div class="col-lg-10 col-lg-offset-1">
                <article class="hentry post post-standard-details text-center">
                        ...
                        <div class="post__content-info">
                            ...
                            <div class="widget w-tags">
                                <div class="tags-wrap">
                                    ...
                                    <a href="{{ route('tag.show', $tag->id )}}" class="w-tags-item">{{ $tag->tag }}</a>
                                    @endforeach
                                </div>
                            </div>
                ...
                <div class="blog-details-author">
                    ...
                    <div class="blog-details-author-content">
                        <div class="author-info">
                            ...
                            <p class="author-info">{{ $post->user->role }}</p>
                        </div>
                ...
                <div class="pagination-arrow">
                    @if($prev)
                    <a href="{{ route('site.show', $prev->slug) }}" class="btn-prev-wrap">
                        <svg class="btn-prev">
                    ...
                    @endif
                    @if ($next)
                    <a href="{{ route('site.show', $next->slug) }}" class="btn-next-wrap">
                        <div class="btn-content">
