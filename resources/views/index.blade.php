...
<body class=" ">
    ...
    <div class="content-wrapper">
                ...
                <div class="col-lg-8">
                    <article class="hentry post post-standard has-post-thumbnail sticky">
                        ...
                        <div class="post-thumb">
                            <img src="{{ $first_post->image_path }}" alt="seo">
                            <div class="overlay"></div>
                            <a href="{{ $first_post->image_path }}" class="link-image js-zoom-image">
                        ...
                        <div class="post__content">
                            ...
                            <div class="post__content-info">
                                ...
                                <h2 class="post__title entry-title text-center">
                                    <a href="{{ route('site.show', $first_post->slug )}}">{{ $first_post->title }}</a>
                                </h2>
                                ...
                                <div class="post-additional-info text-center">
                                    ...
                                    <span class="category">
                                        ...
                                        <a href="{{ route('categories.show', $first_post->category->id )}}">{{
            ...
            <div class="row">
                <div class="col-lg-6">
                    <article class="hentry post post-standard has-post-thumbnail sticky">
                        ...
                        <div class="post-thumb">
                            <img src="{{ $second_post->image_path }}" alt="seo">
                            <div class="overlay"></div>
                            <a href="{{ $second_post->image_path }}" class="link-image js-zoom-image">
                                <i class="seoicon-zoom"></i>
                            </a>
                            <a href="#" class="link-post">
                                <i class="seoicon-link-bold"></i>
                        ...
                        <div class="post__content">
                            ...
                            <div class="post__content-info">
                                ...
                                <h2 class="post__title entry-title text-center">
                                    <a href="{{ route('site.show', $second_post->slug )}}">{{ $second_post->title }}</a>
                                </h2>
                                ...
                                <div class="post-additional-info text-center">
                                    ...
                                    <span class="category">
                                        <i class="seoicon-tags"></i>
                                        <a href="{{ route('categories.show', $second_post->category->id )}}">{{
                ...
                <div class="col-lg-6">
                    <article class="hentry post post-standard has-post-thumbnail sticky">
                        ...
                        <div class="post-thumb">
                            <img src="{{ $third_post->image_path }}" alt="seo">
                            <div class="overlay"></div>
                            <a href="{{ $third_post->image_path }}" class="link-image js-zoom-image">
                                <i class="seoicon-zoom"></i>
                            </a>
                            <a href="#" class="link-post">
                                <i class="seoicon-link-bold"></i>
                        ...
                        <div class="post__content">
                            ...
                            <div class="post__content-info">
                                ...
                                <h2 class="post__title entry-title text-center">
                                    <a href="{{ route('site.show', $third_post->slug )}}">{{ $third_post->title }}</a>
                                </h2>
                                ...
                                <div class="post-additional-info text-center">
                                    ...
                                    <span class="category">
                                        <i class="seoicon-tags"></i>
                                        <a href="{{ route('categories.show', $third_post->category->id )}}">{{
                ...
                <div class="container">
                    <div class="col-lg-12">
                        <div class="offers">
                            ...
                            <div class="row">
                                @foreach ($category->lastThree() as $post)
                                <div class="case-item-wrap">
                                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                        <div class="case-item">
                                            <div class="case-item__thumb">
                                                <img src="{{ $post->image_path }}" alt="our case">
                                            </div>
                        ...
                        <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                            <div class="contacts-item">
                                ...
                                <div class="content">
                                    ...
                                    <p class="sub-title">Tecija b.b.</p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-5c445b3652794e2c"></script>
